...
#create_pblock pblock_shift_rp
#add_cells_to_pblock [get_pblocks pblock_shift_rp] [get_cells -quiet [list design_1_i/shift_rp]]
#resize_pblock [get_pblocks pblock_shift_rp] -add {SLICE_X44Y150:SLICE_X51Y199}
#set_property RESET_AFTER_RECONFIG true [get_pblocks pblock_shift_rp]
#set_property SNAPPING_MODE ON [get_pblocks pblock_shift_rp]
